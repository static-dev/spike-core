  ...
  apply (compiler) {
    ...
    compiler.plugin('emit', (compilation, done) => {
      processedFiles.forEach((f) => {
        ...
        if (!dep) {
          return new Error(`Module ${f.path} not found in webpack.\nMost likely, this is an issue with trying to add a custom loader. If you are trying to output your custom loader files as static, adding 'static-loader' should solve the issue. If you are trying to require them into your javascript, adding the _skipSpikeProcessing option to your loader config should solve the issue.`)
        }
