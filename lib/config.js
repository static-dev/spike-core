...
export default class Config {
  ...
  transformRootsOptionsToWebpack (opts) {
    ...
    const rootsLoaders = [
      { test: mmToRe(opts.matchers.css), exclude: opts.ignore.map(mmToRe), loader: 'css-loader!postcss-loader', core: true },
      { test: mmToRe(opts.matchers.js), exclude: opts.ignore.map(mmToRe), loader: 'babel-loader', core: true },
      { test: mmToRe(opts.matchers.jade), exclude: opts.ignore.map(mmToRe), loader: 'jade-static-loader', core: true },
      { test: mmToRe(opts.matchers.static), exclude: opts.ignore.map(mmToRe), loader: 'file-loader', query: { dumpDirs: opts.dumpDirs }, core: true }
    ]
