...
// any more involved config changes will have to be made through webpack
// configurator, which will be made available but more common config options
// will be exposed through a much more straightforward interface
...
module.exports = {
  ...
  plugins: [
    ...
    new CSSPlugin({ matcher: cssMatcher })
  ]
}
