...
- [pug](http://jade-lang.com/) for markup
...
**matchers**           | An object with `pug`, `css`, and `js` keys. Each key is a [micromatch](https://github.com/jonschlinkert/micromatch) string, and represents which files should be pulled into the pipeline to be processed. Be very careful if you are trying to change this.                                                                       | `**/*.pug`, `**/*.css`, and `**/*.js`
...
**pug**               | A [configuration object for pug](http://jade-lang.com/api/).                                                                                                                                                                                                                                                                       |
