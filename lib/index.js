...
function initSprout (emit) {
  try {
    fs.accessSync(Spike.tplPath, fs.constants.F_OK | fs.constants.R_OK | fs.constants.W_OK)
  } catch (_) {
...
function ensureConfigExists () {
  ...
  try {
    fs.accessSync(Spike.configPath, fs.constants.F_OK | fs.constants.R_OK | fs.constants.W_OK)
  } catch (_) {
